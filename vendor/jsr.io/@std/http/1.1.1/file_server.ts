...
import { normalize as posixNormalize } from "jsr:@std/path@^1.1.5/posix/normalize";
import { extname } from "jsr:@std/path@^1.1.5/extname";
import { join } from "jsr:@std/path@^1.1.5/join";
import { relative } from "jsr:@std/path@^1.1.5/relative";
...
import { ByteSliceStream } from "jsr:@std/streams@^1.1.1/byte-slice-stream";
